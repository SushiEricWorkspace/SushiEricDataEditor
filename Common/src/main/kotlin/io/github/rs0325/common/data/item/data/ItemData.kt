...
import io.github.rs0325.common.data.core.structure.EditorMeta
import io.github.rs0325.common.data.core.validation.PropertyError
import io.github.rs0325.common.data.item.ItemValidator
import io.github.rs0325.common.data.item.data.detail.ItemDetail
...
data class ItemData(
     ...
     *
     * #### 仕様:
     * - 現在のItemDataインスタンスを検証対象として持つ [io.github.rs0325.common.data.item.ItemValidator] を返します。
     * - バリデーション処理本体は [io.github.rs0325.common.data.item.ItemValidator] 側に委譲します。
     * - GUIなどで特定項目だけを検証したい場合は、この関数で取得したValidatorから
     *   `validateVanillaId()` や `validateStat(...)` などを呼び出します。
     *
     * @return このItemDataを検証対象にした [io.github.rs0325.common.data.item.ItemValidator]。
     */
